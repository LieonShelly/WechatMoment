...
@property (nonatomic, readonly, strong) UIVisualEffect * _Nullable effect;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<UIImage *> * _Nonnull musicLoadingImages;)
+ (NSArray<UIImage *> * _Nonnull)musicLoadingImages SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC5PKHUD17PKHUDErrorTipView")
@interface PKHUDErrorTipView : PKHUDSquareBaseView
- (nonnull instancetype)init:(NSString * _Nullable)text OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
